...
export interface _SERVICE {
  ...
  'getCallerRewardStatus' : ActorMethod<
    [],
    {
      'rewardPerGame' : bigint,
      'dailyCap' : bigint,
      'gamesEarnedToday' : bigint,
      'canClaim' : boolean,
    }
  >,
  'getCallerStkBalance' : ActorMethod<[], bigint>,
  'getCallerStkBalanceLive' : ActorMethod<[], bigint>,
  ...
  'getCurrentRewardPerGame' : ActorMethod<[], bigint>,
  'getDailyRewardLimit' : ActorMethod<[], bigint>,
  ...
  'getLedgerPrincipal' : ActorMethod<
    ...
    { 'ok' : Principal } |
      { 'err' : string }
  >,
  'getMatchReward' : ActorMethod<[], bigint>,
  ...
  'setAdminTreasuryAccount' : ActorMethod<
    ...
    { 'ok' : null } |
      { 'err' : string }
  >,
  'setBurnFee' : ActorMethod<[bigint], { 'ok' : null } | { 'err' : string }>,
  'setDailyRewardLimit' : ActorMethod<
    [bigint],
    { 'ok' : null } |
      { 'err' : string }
  >,
  'setLedgerPrincipal' : ActorMethod<
    ...
    { 'ok' : null } |
      { 'err' : string }
  >,
  'setMatchReward' : ActorMethod<
    [bigint],
    { 'ok' : null } |
      { 'err' : string }
  >,
  'startGame' : ActorMethod<[], { 'ok' : null } | { 'err' : string }>,
